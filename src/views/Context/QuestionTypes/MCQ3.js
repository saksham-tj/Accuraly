...
export default function MCQ3(props) {
  ...
  const submit = useSubmit(
    [questionText, option1, option2, option3],
  ...
  function handleSuccess(formData) {
    ...
    let questionData = {
      questionType: Object.keys(contextQuestionTypes)[1],
  ...
  return (
    <div className="questionContainer">
      ...
      <FormGroup row>
        ...
        <Col xs="12" md="9">
          <Dropdown isOpen={isDropDownOpen} toggle={handleDropDown} disabled={isDisabled}>
            <DropdownToggle caret>{correctOption.key}</DropdownToggle>
            <DropdownMenu>
              <DropdownItem
                active={correctOption.value === option1.props.value}
                onClick={() =>
                  handleDropdownItem({
                    key: option1.props.name,
                    value: option1.props.value
              ...
              <DropdownItem
                active={correctOption.value === option2.props.value}
                onClick={() =>
                  handleDropdownItem({
              ...
              <DropdownItem
                active={correctOption.value === option3.props.value}
                onClick={() =>
                  handleDropdownItem({
